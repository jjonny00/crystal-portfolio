...
const GlowingSphereImage = ({
  ...
  useEffect(() => {
    if (texture) {
      ...
      if (debugMode) {
        if (process.env.NODE_ENV === "development") console.log('🌟 Enhanced sphere texture loaded:', {
  ...
  useEffect(() => {
    ...
    if (currentForm !== lastCrystalForm.current) {
      ...
      if (currentForm === 'exploded' && lastCrystalForm.current === 'whole') {
        ...
        if (debugMode) if (process.env.NODE_ENV === "development") console.log('🌟 Enhanced sphere: Start explosion with anti-banding');
        
      } else if (currentForm === 'whole' && lastCrystalForm.current === 'exploded') {
        setIsExploding(false);
        if (debugMode) if (process.env.NODE_ENV === "development") console.log('🌟 Enhanced sphere: Stop explosion');
      }
