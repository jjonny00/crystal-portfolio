...
import projects, { facetKeys as crystalFacetKeys, getProjectColorByFacetKey, getProjectModelKeyByFacetKey } from '../../data/projects'
...
const UnifiedCrystalScene = forwardRef(({ 
  ...
  // Facet configuration
  const facetKeys = crystalFacetKeys;
