...
const OverviewConnectorLines = ({
  ...
  const RELAX_DURATION = 0.34;
  const RELAX_OVERSHOOT_DURATION = 0.08;
  const RELAX_REBOUND_DURATION = 0.09;
  const RELAX_SETTLE_DURATION = 0.1;
  const STRAIGHT_OVERSHOOT_PROGRESS = 1.08;
  const STRAIGHT_REBOUND_PROGRESS = 0.985;
  const RELAX_OVERSHOOT_PROGRESS = -0.22;
  const RELAX_REBOUND_PROGRESS = 0.12;
