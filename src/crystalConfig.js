...
export const timing = {
  ...
  heroOverviewRuntime: {
    ...
    cameraPushbackDecayStart: 0.2,
    cameraPushbackDecayEnd: 0.58,
    ...
    fragmentBlastPortion: 0.08,
    fragmentBlastTravel: 0.76,
    fragmentSlowPortionEnd: 0.25,
    fragmentSlowTravelEnd: 0.92,
    fragmentTravelCurveStrength: 2.8,
    fragmentSettleCurveStrength: 3.1,
  },
}
