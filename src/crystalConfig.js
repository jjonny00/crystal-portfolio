...
export const timing = {
  ...
  heroOverviewRuntime: {
    ...
    heroOverviewExplosionParticleBurstCount: 180,
    heroOverviewFractureRingOpacity: 2.6,
    heroOverviewFractureRingScale: 28,
    heroOverviewFractureRingDurationMs: 320,
    heroOverviewExplosionParticlesEnabled: true,
    heroOverviewFractureRingImpactEnabled: true,
    heroOverviewCameraShakeEnabled: true,
    heroOverviewCameraArcEnabled: true,
    heroOverviewCameraPushbackDelayEnabled: true,
    ...
    fragmentBlastPortion: 0.05,
    fragmentBlastTravel: 0.50,
    fragmentMidPortionEnd: 0.25,
    fragmentMidTravel: 0.60,
    fragmentSlowPortionEnd: 0.75,
    fragmentSlowTravelEnd: 0.90,
    fragmentTravelEaseType: 'normalizedExpoOut',
    fragmentTravelEaseStrength: 2.4,
    fragmentTravelImpulseRate: 5.5,
    fragmentTravelTimeExponent: 1.35,
